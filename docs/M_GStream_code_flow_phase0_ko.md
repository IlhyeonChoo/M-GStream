...
이 저장소는 단순한 "가우시안 스플래팅 렌더러 하나"가 아니라, **SIBR(System for Image-Based Rendering) 코어 프레임워크 위에 `M_GStream` 프로젝트를 얹은 C++/CUDA 기반 뷰어 애플리케이션**이다.
...
- `src/projects/M_GStream/renderer/subsystem/Subsystem.hpp`
- `src/projects/M_GStream/renderer/subsystem/archive_system/ArchiveSystem.hpp`
- `src/projects/M_GStream/renderer/subsystem/archive_system/ArchiveSystem.cpp`
- `src/projects/M_GStream/renderer/subsystem/UI_system/UISystem.hpp`
- `src/projects/M_GStream/renderer/subsystem/UI_system/UISystem.cpp`
...
- `src/projects/M_GStream/renderer/resource/GaussianField.hpp`
...
- `src/projects/M_GStream/renderer/subsystem/rendering_system/RenderGaussianScene.hpp`
- `src/projects/M_GStream/renderer/subsystem/rendering_system/RenderGaussianScene.cpp`
...
- `src/projects/M_GStream/renderer/cuda/TransformKernels.cuh`
- `src/projects/M_GStream/renderer/cuda/TransformKernels.cu`
