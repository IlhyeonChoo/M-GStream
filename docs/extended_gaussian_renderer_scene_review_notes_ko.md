...
- `rg "getField\\(|getDescriptor\\(" src/projects/extended_gaussian`
- `rg "getCpuFieldShared\\(" src/projects/extended_gaussian`
...
- `rg "getEular|getEuler|setEular|setEuler|eular_angle|euler_angle" src/projects/extended_gaussian`
...
1. `extended_gaussianViewer_app` 빌드 성공
