...
이 부분은 거의 전부 `src/projects/extended_gaussian/*` 안에 있다.
...
2. `src/projects/extended_gaussian/renderer/ExtendedGaussianViewer.*`
3. `src/projects/extended_gaussian/renderer/resource/*`
4. `src/projects/extended_gaussian/renderer/scene/*`
5. `src/projects/extended_gaussian/renderer/subsystem/rendering_system/*`
