...
#include "projects/M_GStream/renderer/scene/GaussianInstance.hpp"
#include "RenderUtils.hpp"
#include "projects/M_GStream/renderer/cuda/TransformKernels.cuh"
	...
	public:
		...
		BufferCopyRenderer()
		{
			_shader.init("CopyShader",
				sibr::loadFile(sibr::getShadersDirectory("M_GStream") + "/copy.vert"),
				sibr::loadFile(sibr::getShadersDirectory("M_GStream") + "/copy.frag"));
